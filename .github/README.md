...
[`@aws-sdk/client-iot-wireless`](https://www.npmjs.com/package/@aws-sdk/client-iot-wireless/v/3.454.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iot-wireless@3.454.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-n45WjbaS1eITCgkaoVKTZMVyd5JqOabxCSmu9k4gqzW/ulgcXmnZLAeVpkRqZpPZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-iot-wireless": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iot-wireless@3.454.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-iot-wireless@3.454.0/index.min.mjs": "sha384-n45WjbaS1eITCgkaoVKTZMVyd5JqOabxCSmu9k4gqzW/ulgcXmnZLAeVpkRqZpPZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-iot-wireless/blob/refs/tags/3.454.0/LICENSE
```
